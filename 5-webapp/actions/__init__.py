...
interaction (GPS mock-location today; app launch/install, screenshots,
notifications, etc. could each be their own action module later). Keeping
every action in its own file under actions/, wrapped by its own thin
Flask blueprint under routes/, is what makes adding a new capability a
matter of adding two small files rather than touching shared code - see
"Adding a new action" in README.md.
